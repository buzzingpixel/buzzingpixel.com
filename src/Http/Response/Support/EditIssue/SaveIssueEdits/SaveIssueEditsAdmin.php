...
class SaveIssueEditsAdmin implements SaveIssueEditsContract
{
    ...
    public function save(
        ...
        return $this->issuesApi->saveIssue(
            issue: $issue
                ...
                ->withSolution(solution: $formValues->solution()->toString())
                ->withStatus(status: $formValues->status()->toString())

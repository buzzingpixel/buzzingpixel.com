...
final class Version20210314044656 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE schedule_tracking (id UUID NOT NULL, class_name VARCHAR(255) NOT NULL, is_running BOOLEAN NOT NULL, last_run_start_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, last_run_end_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');

...
final class Version20210328033607 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE software (id UUID NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, is_for_sale BOOLEAN NOT NULL, price INT NOT NULL, renewal_price INT NOT NULL, is_subscription BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN software.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE software_versions (id UUID NOT NULL, software_id UUID DEFAULT NULL, major_version VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, download_file VARCHAR(255) NOT NULL, upgrade_price INT NOT NULL, released_on TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');

...
final class Version20210307052924 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE user_sessions (id UUID NOT NULL, user_id UUID NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, last_touched_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');

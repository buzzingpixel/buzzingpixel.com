...
final class Version20210422230302 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE order_items (id UUID NOT NULL, order_id UUID DEFAULT NULL, license_id UUID DEFAULT NULL, softare_id UUID DEFAULT NULL, price INT NOT NULL, original_price INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_62809DB0A6CF31DF ON order_items (softare_id)');
        ...
        $this->addSql('COMMENT ON COLUMN order_items.softare_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE order_items ADD CONSTRAINT FK_62809DB0A6CF31DF FOREIGN KEY (softare_id) REFERENCES software (id) NOT DEFERRABLE INITIALLY IMMEDIATE');

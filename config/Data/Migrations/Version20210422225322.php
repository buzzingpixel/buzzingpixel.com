...
final class Version20210422225322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN licenses.softare_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE licenses ADD CONSTRAINT FK_7F320F3FA6CF31DF FOREIGN KEY (softare_id) REFERENCES software (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }

...
final class Version20210306055533 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE user_password_reset_tokens (id UUID NOT NULL, user_id UUID NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id, user_id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F963EF68BF396750 ON user_password_reset_tokens (id)');

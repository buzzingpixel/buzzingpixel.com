...
final class Version20210427034036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart_items (id UUID NOT NULL, cart_id UUID DEFAULT NULL, software_id UUID DEFAULT NULL, quantity INT NOT NULL, slug VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN cart_items.software_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE cart_items ADD CONSTRAINT FK_BEF48445A6CF31DF FOREIGN KEY (software_id) REFERENCES software (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }

...
use App\Http\Response\Software\AnselCraft\Documentation\V1\AnselCraftV1DocIndex;
...
return static function (App $app): void {
    ...
    $app->get('/software/ansel-craft/documentation/v1', AnselCraftV1DocIndex::class);
};
